<template>
  <section class="team-area-1 space overflow-hidden team-slider-2">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div
                ...
                :style="{
                  backgroundImage:
                    'url(/assets/frontend/img/shape/team-2-bg-shape.png)',
                }"
              >
                <div class="team-img">
            ...
            <div class="swiper-slide">
              ...
              >
                <div class="team-img">
                  <img
                    src="/assets/frontend/img/team/team_2_2.png"
                    alt="Team"
                  />
                </div>
                <div class="team-content">
...
.team-slider-2 .team-card.style-2 {
