<template>
  ...
  >
    ...
    <template v-for="(row_item, index) in setup.table_row_data" :key="index">
      ...
      <td v-else-if="row_item == 'banner_image'" class="text-wrap max-w-120">
      <a :href="item[row_item]" data-lightbox="pages" target="_blank" >
        <img :src="item[row_item]" alt="Image" class="table-image" width="80" height="60" />
      </a>
      </td>
