         ...
         <div class="row">
             <div class="col-lg-6 align-self-center">
                 <div class="about-us-img-wrap about-img-left">
                     ...
                     <a href="{{ asset($about_us?->primary_image ?? 'uploads/default.jpg') }}"
                         data-rel="lightcase:myCollection">
                         <img class="about_us_custom"
                             src="{{ asset($about_us?->primary_image ?? 'uploads/default.jpg') }}" alt="About Us Image">
                     ...
                     <div class="about-us-img-info about-us-img-info-2 about-us-img-info-3">
                         ...
                         <div class="ltn__video-img ltn__animation-pulse1">
                             ...
                             <img src="{{ asset($about_us?->secondary_image ?? 'uploads/default.jpg') }}"
