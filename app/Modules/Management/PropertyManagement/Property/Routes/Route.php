...
Route::prefix('v1')->group(function () {
    Route::prefix('properties')->group(function () {
        ...
        Route::post('proprerty-image-delete/{slug}', [Controller::class, 'DeletePropertyImage']);
        Route::post('proprerty-floor-plan-image-delete/{slug}', [Controller::class, 'DeletePropertyFloorPlanImage']);
    });
});
